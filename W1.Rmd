...
Materiały: https://github.com/michbur/WizualizacjaDanych2022-2023L
...
Inspiracje: [CMDSonline](https://cmdsonline.com/)

<img src="https://www.cmdsonline.com/wp-content/uploads/10.15.CMDS_.InfographiconInfographics.png" width="300px" class="center">
...
<img src="https://www.oldstreetsolutions.com/wp-content/uploads/2021/05/3D-Chart-1024x803.png" width="600px">
...
<a href="https://www.visualcapitalist.com/wp-content/uploads/2023/03/HoP-Main-Graphic-03012023.jpg"><img src="https://www.visualcapitalist.com/wp-content/uploads/2023/03/HoP-Main-Graphic-03012023.jpg" width="700px"></a>
...
ggplot(cbind(expand.grid(x = c("Imperatywne\n", "Deklaratywne\n"),
                         y = c("Proste do użycia", "Wszechstronne")), 
             software = c("Seaborn", "Bokeh, Plotnine\nR (ggplot2)\nLeaflet\nVega-Lite",  "Matplotlib\nR (base, grid)", "BQPlot\nD3\nPlotly\nVega")),
       aes(x = x, y = y, label = software)) +
  geom_tile(fill = NA, color = "black") +
  geom_text()  +
  theme_void() +
...
Podobnie do altair, inspirowane gramatyką grafiki do wizualizacji danych. W przeciwieństwie do altair, jest dokładną kopią ggplot2, włącznie ze składnią.
...
Przyszłość wizualizacji danych to również narzędzia wspierające projektowanie wizualizacji za pomocą AI: https://github.com/astoeckl/NLP2Chart2.
...
<img src="img/ai2.png" width="600px">
...
Ankieta: https://forms.gle/8BZoQT84VqZgtgJY9
